...
class CreateELERequest extends StatefulWidget {
  @override
  _CreateELERequestState createState() => _CreateELERequestState();
}

class _CreateELERequestState extends State<CreateELERequest>
    with AutomaticKeepAliveClientMixin<CreateELERequest> {
  ...
  List<ELE> listELE = [];
  File file;
  var dbRef = FirebaseDatabase.instance.reference().child("ELE Requests");
    ...
    return StreamBuilder(
        ...
        builder: (context, AsyncSnapshot<Event> snapshot) {
          if (snapshot.hasData) {
            ...
            print("listELE length = ${listELE.length}");
  ...
  Future<Null> _showELErequets(BuildContext context) async {
  ...
  getData() {
    ...
    dbRef
      ...
      if (snapshot.value != "") {
        ...
        ref.child("ELE Requests").once().then((DataSnapshot snap) {
          print(snap.value);
