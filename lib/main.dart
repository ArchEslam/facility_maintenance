...
class GetMassegValue extends StreamView<GetMassegValue> {
  GetMassegValue._(this._controller, this._notificationsHandler)
      : super(_controller.stream);

  factory GetMassegValue() =>
      GetMassegValue._(StreamController(), sl<NotificationsHandler>());

  final StreamController<GetMassegValue> _controller;
  final _notificationsHandler;

  Future<void> close() => _controller.close();

  Map<String, dynamic> message;

  onFirebaseMessagingConfigure() async {
    message = _notificationsHandler.initializeMessaging();
  }
}
